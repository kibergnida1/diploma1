...
def login_prompt(secrets_manager_cls: Type[BaseSecretsManager], style: Style):
    ...
    If you have used this project before and already have secure configs stored,
    ...
    Enter your new password:""",
        ...
        password = input_dialog(
            title="Welcome back to my diploma",
...
def migrate_configs_prompt(secrets_manager_cls: Type[BaseSecretsManager], style: Style) -> BaseSecretsManager:
    message_dialog(
        ...
        text="""
            ...
            We have recently refactored the way project handles configurations.
...
def show_welcome(style: Style):
    ...
    PLEASE READ THIS CAREFULLY BEFORE USING PROJECT:

    This project is a free and open source software client that helps you build algorithmic
    ...
    You are solely responsible for the trades that you perform using project.
    ...
    To use project, you will need to give it access to your crypto assets by entering
